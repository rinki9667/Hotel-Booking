...
const HotelReg = () => {
  ...
  return (
    <div onClick={()=> setShowHotelReg(false)} className='fixed top-0 bottom-0 left-0 right-0 z-100 flec items-center
            ...
            <div className='relative flex flex-col items-center md:w-1/2 p-8 md:p-10'>
                ...
                {/* { Hotel name} */}
                  ...
                  {/* { Phone} */}
                    ...
                    <input  onChange={(e)=> setContact(e.target.value)} value={contact} id='contact' type="number"  placeholder="Type here" className="border
                    border-gray-200 rounded w-full px-3 py-2.5 mt-1 outline-indigo-500
                    font-light" required/>
                    </div>
                     {/* { Address} */}
