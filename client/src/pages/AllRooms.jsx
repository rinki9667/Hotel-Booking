...
const roomsType = [
  ...
  const sortOptions = [
    ...
    justify-between pt-28 md:pt-3.5 px-4 md:px-16 lg:px-24
    xl:px-32'>
     <div>
      <div className='flex flex-col items-start text-left p-20'>
      ...
      {roomsDummyData.map((room)=>(
        ...
        last:pb-30 last:border-0'>
            ...
            className='max-h-56 md:w-1/2 rounded-xl shadow-lg object-cover
            cursor-poointer' />
        ...
        <span className='hidden lg:block'>CLEAR</span>
         ...
         overflow-hidden transition-all duration-700`}>
            <div className='px-5 pt-5'>
                <p className='font-mediuim text-gray-800 pb-2'>popular filters</p>
            ...
            <div className='px-5 pt-5 pb-7'>
                <p className='font-mediuim text-gray-800 pb-2'>PriceRanges</p>
                {priceRanges.map((ranges, index)=>(
                    <checkBox key={index} label={`$ ${ ranges}`}/>
                    
                ))}

            </div>
             <div className='px-5 pt-5'>
                <p className='font-mediuim text-gray-800 pb-2'>Sort By</p>
