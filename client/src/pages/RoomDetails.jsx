  ...
  return  room && (
        ...
        <div className='grid grid-cols-2 gap-4 lg:w-1/2 w-full'>
            {room?.images.length > 1 && room.images.map((images, index)=>(
                <img onClick={()=>setMainImage(images)}
                 key={index} src={images} alt="Room Images"
            ...
            <div className='flex flex-wrap items-center mt-3 mb-6 gap-4'>
                {room.amenities.map((items, index)=>(
                        ...
                        rounded-lg bg-gray-100'>
                            <img src={facilityIcons[items]} alt={"item"} className='w-5
                            h-5' />
    ...
    mx-auto mt-16 max-w-6xl'>
        ...
        md:items-center gap-4 md:gap-10 text-gray-500'>
            ...
            <div className='flex flex-col'>
                ...
                <input type="date" id='check-OutData' placeholder='Check-In'
           ...
           <div className='w-px h-15 bg-gray-300/70 max-md:hidden'></div>
            <div className='flex flex-col'>
                ...
                <input type="date" id='check-OutData' placeholder='Check-Out'
                className='w-full rounded border border-gray-300 px-3 py-2 mt-1.5
                outline-none' required />
            </div>
        ...
        max-md:mt-6 md:px-52 py-3 md:py-4 text-base cursor-pointer'>
             Check Availability
        </button>
    ...
    <div className='flex flex-col items-start gap-4'>
        <div className='flex gap-4'>
            <img src={room.hotel.owner.image} alt="Hotel" className='h-14 w-14
            md:h-18 md:w-18 rounded-full' />
            <div>
                <p className='text-lg md:text-xl'>Hosted by</p>
        ...
        <button className='px-6 py-2.5 mt-4 rounded text-white bg-amber-300
        hover:bg-amber-400 transition-all cursor-pointer'>Contact Now</button>
